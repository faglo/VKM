...
function Login(){
    ...
    return(
        <Container component={"main"} maxWidth="xs" sx={{paddingTop: 8}}>
            ...
            <Dialog maxWidth="xs" open={captcha.length > 0}>
                ...
                <DialogContent>
                    <Grid container justify="center" alignItems="center" spacing={3}>
                        ...
                        <Grid item xs={12}>
                            <Button variant="contained" fullWidth disabled={captchaValue.length === 0}>Submit</Button>
                        </Grid>
                        <Grid item xs={12}>
            ...
            <Dialog maxWidth="xs" open={isTwoFactor}>
                ...
                <DialogContent>
                    <Grid container justify="center" alignItems="center" spacing={3}>
                        ...
                        <Grid item xs={12}>
                            <Button variant="contained" fullWidth disabled={twoFactorCode.length === 0}>Submit</Button>
                        </Grid>
                        <Grid item xs={12}>
